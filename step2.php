...
<?php
 if(isset($_POST['text'])){
 	file_put_contents('textUploads/' . time() . '.txt', $_POST['text']);
 }
?>
<div id="step-title">
	STEP 2
...
<div id="feature-title">
	Please upload the book that Stencrypt will use as a key then click "Next Step"
</div>
...
<a id="next-step-button" onclick="loadPage('step3.php'); return false;">
	<div class="button">
		<p>
